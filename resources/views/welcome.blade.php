					...
					<table class="table table-striped table-bordered table-hover">
						<tbody>
							<tr>
								<td>姓名</td>
								<td>
									<input type="text" name="name" id="name" style="font-size: 12pt; font-family: 新細明體" size="10" value="">
								</td>
							</tr>
							<tr>
								<td>單位</td>
							...
							<tr>
								<td>彌勒救苦真經</td>
								<td><input type="text" name="b1" id="book1" style="font-size: 12pt; font-family: 新細明體" maxlenght="3" size="3" value=""></td>
							</tr>
							<tr>
								<td>心經</td>
								<td><input type="text" name="b2" id="book2" style="font-size: 12pt; font-family: 新細明體" maxlenght="3" size="3" value=""></td>
							</tr>
							<tr>
								<td>號召令</td>
								<td><input type="text" name="b3" id="book3" style="font-size: 12pt; font-family: 新細明體" maxlenght="3" size="3" value=""></td>
							</tr>
							<tr>
								<td>一日一齋</td>
								<td><input type="text" name="veg" id="veg" style="font-size: 12pt; font-family: 新細明體" maxlenght="3" size="3" value=""></td>
							</tr>
							<tr>
								<td>叩首</td>
								<td><input type="number" name="kotow" id="kotow" style="font-size: 12pt; font-family: 新細明體" maxlenght="4" size="4" step="1" value=""></td>
							</tr>
						</tbody>
					</table>
				</form>
			...
			<div class="row text-center">
				...
				<div class="col">
					<div class="card mb-3 rounded-3 shadow-sm">
						...
						<div class="card-body">
							<h1 class="card-title pricing-card-title">
								<small class="text-muted fw-light">叩首累計</small> {{ $kotow }}
								<small class="text-muted fw-light">次</small>
							</h1>
						</div>
					</div>
